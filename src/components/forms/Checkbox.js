...
const CheckBoxKus = ({ selected, onPress, style, textStyle, size = 30, color = COLORS.registratioButton, text = '', ...props}) => 
{
    const [showTermsModal,setShowTermsModal] = useState(false);
    const [termsText, setTermsText] = useState('');
    const showModal = () => {
        setShowTermsModal(true);
        var textTerms = <Text style={styles.text}>Terms and Conditions goes here</Text>
